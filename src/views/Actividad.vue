  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Cuestionario acerca de fundamentos de calidad de 
            em software
        p.mb-4 Afianzar los conceptos más importantes asociados a la calidad del 
          em software
          | , modelos y metodologías de desarrollo y plan de pruebas.
        .tarjeta.tarjeta--azul.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0 Preguntas de selección múltiple con única respuesta.
            .col-auto
